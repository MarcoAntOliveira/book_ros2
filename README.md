...
See [pixi.md](pixi.md) for Pixi/RoboStack setup instructions (Jazzy/Kilted), including how to copy `pixi.toml` to the workspace root, build with Pixi, open shells, and run `rmw_zenohd`.
